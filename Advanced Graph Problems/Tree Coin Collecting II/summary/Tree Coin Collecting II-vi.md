...
**CSES ID:** 3149  
**Đề bài gốc:** https://cses.fi/problemset/task/3149  
**Giới hạn thời gian:** 1.00s | **Giới hạn bộ nhớ:** 512MB

> Tóm tắt đề bài.

Cho một cây $n$ đỉnh, một số đỉnh được đánh dấu chứa đồng xu. Trả lời $q$ truy vấn: với cặp $(a,b)$, tìm độ dài đường đi ngắn nhất từ $a$ đến $b$ đi qua mọi đỉnh có đồng xu.
